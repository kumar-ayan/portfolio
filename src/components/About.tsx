            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-12 md:gap-24">
                    <p className="text-xl md:text-2xl font-medium leading-relaxed max-w-2xl opacity-90">
                        Second-year B.Tech Computer Science student with strong foundations in Data Structures & Algorithms (350+ problems solved across Easy–Hard) and hands-on experience building AI and full stack applications. Currently working on full stack applications and open source contributions.
                    </p>
